...
mseFile = 'AdobeData/mse_IWR_0.5_prediction_20000_30000.txt'
with open(mseFile, 'w') as rf:
    rf.writelines(['Point\tMSE\n'])
absFile = 'AdobeData/absolute_IWR_0.5_prediction_20000_30000.txt'
with open(absFile, 'w') as ro:
    ro.writelines(['Point\tAbs\n'])

vals = []

with open('AdobeData/IWR-CTR-RF-0.5.txt', 'r') as fr:
    fr.readline()
...
for j in range(jumps, jumps-100, -1):
    dataset = vals[:j*100]
