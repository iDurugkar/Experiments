...
with open('IWRs_out.txt','r') as fp:
    text = fp.read()
...
def build_net(inputVar):
    ...
    # GRU layer
    l_lstm = GRULayer(l_rshp1, num_units=num_outputs)
    ...
    # l_dense = DenseLayer(l_rshp2, num_units=num_outputs)
    l_out = ReshapeLayer(l_lstm, (batch_size, sequence_length))
